...
UINT Cloth::RowCount()const
{
	return numRows;
}

UINT Cloth::ColumnCount()const
{
	return numCols;
}

UINT Cloth::VertexCount()const
{
	return vertexCount;
}

UINT Cloth::TriangleCount()const
{
	return triangleCount;
}

float Cloth::Width()const
{
	return numCols*dx;
}

float Cloth::Depth()const
{
	return numRows*dx;
}

void Cloth::Init(UINT m, UINT n, float ddx, float ddt, float spring1, float spring2, float damp1,float damp2,float M)
{
	mass= M;
	numRows  = m;
	numCols  = n;
